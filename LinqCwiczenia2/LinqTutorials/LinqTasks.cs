...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = (from emp in Emps where emp.Job == "Backend programmer" select emp).ToList();
        ...
        public static Emp Task9()
        {
            var result = Emps
                ...
                .First() ?? throw new ArgumentNullException("Emps\n                .Where(emp => emp.Job == \"Frontend programmer\")\n                .OrderByDescending(emp => emp.HireDate)\n                .First()");
        ...
        {
            IEnumerable<object> result = Emps?.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new { dept.Dname, emp.Empno })
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            var result = emps.Where(e => emps.Any(e2 => e != null && e2.Mgr == e.Mgr)).OrderBy(e => e.Ename)
